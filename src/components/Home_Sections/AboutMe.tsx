    ...
    return (  
        ...
        >
            ...
            <div className='sticky top-50 h-screen w-full grid grid-cols-2'>
                <p className="text-white max-sm:text-[14px] text-3xl">I'm Atheo Jester -  Full-stack developer building fast, scalable, immersive digital experiences with creativity and engineering precision.</p>
            </div>
            ...
            <div className='w-full px-4 pt-[200px]'>
                <FloatDiv 
                    ...
                    className='bg-white p-5 shadow-xl rounded max-sm:w-[60%] w-[40%] z-9 relative max-sm:mx-0 ml-auto mb-10'
                />
                <Education 
                    start={speeds2.start}
                    end={speeds2.end}
                    className='bg-white mt-20 shadow-lg p-5 shadow-xl rounded max-sm:w-[60%] w-[40%] z-9 relative max-sm:mx-0 ml-[600px] mb-10'
                />
                <Experience
                    start={speeds2.start}
                    end={speeds2.end}
                    className='bg-white mt-[-40px] shadow-lg p-5 shadow-xl rounded max-sm:w-[60%] w-[40%] z-9 relative max-sm:mx-0 ml-auto mb-20'
                />
